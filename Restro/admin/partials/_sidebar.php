        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="dashboard.php">
              <i class="ni ni-tv-2 text-primary"></i> <?php echo __('dashboard'); ?>
            </a>
          </li>
          <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="customes.php">
              <i class="fas fa-users text-primary"></i> <?php echo __('customers'); ?>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="products.php">
              <i class="ni ni-bullet-list-67 text-primary"></i><?php echo __('products'); ?>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="orders.php">
              <i class="ni ni-cart text-primary"></i> <?php echo __('orders'); ?>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="payments.php">
              <i class="ni ni-credit-card text-primary"></i> <?php echo __('payments'); ?>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="receipts.php">
              <i class="fas fa-file-invoice-dollar text-primary"></i> <?php echo __('receipts'); ?>
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="versement.php">
              <i class="fas fa-user-tie text-primary"></i> <?php echo __('manage_versement'); ?>
            </a>
          </li>
        </ul>
        <!-- Divider -->
