                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col"><?php echo __('products'); ?></th>
                                        <th scope="col"><?php echo __('total'); ?> <?php echo __('price'); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-info" type="button" 
                                                        ...
                                                        aria-expanded="false">
                                                    <i class="fas fa-list"></i> <?php echo __('view_items'); ?>
                                                </button>
                                            ...
                                            <td>
                                                ...
                                                <a href="payments.php?cancel_order=<?php echo $order->order_code; ?>" 
                                                   onclick="return confirm('Are you sure you want to refund this entire order?');">
