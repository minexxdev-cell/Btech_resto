...
<body>
                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <input type="text" id="searchInput" class="form-control no-print" placeholder="Search by customer name...">
                                </div>
                            </div>
                        </div>
    ...
    for (var i = 0; i < rows.length - 1; i++) { // -1 to skip grand total row
        ...
        // Check if row has td elements (to avoid grand total row issues)
        if (cells.length > 0) {
            var customer = cells[0].textContent.toLowerCase(); // First td is customer name
            
            if (customer.indexOf(input) > -1) {
