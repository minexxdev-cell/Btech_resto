...
$payment_query = "SELECT SUM(pay_amt) as total_payments FROM rpos_payments";
...
// Calculate total versements
$versement_query = "SELECT SUM(amt) as total_versements FROM rpos_versement";
                    ...
                    <div class="card shadow">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="versementTable">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM rpos_versement ORDER BY created_at DESC";
                                    $stmt = $mysqli->prepare($query);
                                    $stmt->execute();
                                    $res = $stmt->get_result();
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="versement.php?delete=<?php echo $versement->id; ?>" 
